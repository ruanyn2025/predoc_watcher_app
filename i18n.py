...
S.update({
    # ---- 申请追踪 ------------------------------------------------------
    "nav.apps":       ("申请追踪", "申請追蹤", "Applications", "Candidatures", "Candidaturas"),
    "apps.title":     ("申请追踪", "申請追蹤", "Applications", "Candidatures", "Candidaturas"),
    "apps.sub":       ("按投递时间倒序", "按投遞時間倒序", "newest first",
                       "les plus récentes d'abord", "las más recientes primero"),
    "apps.empty":     ("还没有投递记录。在收藏夹里点「完成投递」，岗位就会搬到这里。",
                       "還沒有投遞記錄。在收藏夾裡點「完成投遞」，職缺就會搬到這裡。",
                       "No applications yet. Hit “Applied” on a starred posting to move it here.",
                       "Aucune candidature. Cliquez sur « Envoyée » sur une offre en favori pour la déplacer ici.",
                       "Sin candidaturas. Pulsa «Enviada» en una oferta guardada para moverla aquí."),
    "apps.mark":      ("完成投递", "完成投遞", "Applied", "Envoyée", "Enviada"),
    "apps.mark_hint": ("标记为已投递，移到申请追踪页", "標記為已投遞，移到申請追蹤頁",
                       "Mark as applied and move to Applications",
                       "Marquer comme envoyée et déplacer vers Candidatures",
                       "Marcar como enviada y mover a Candidaturas"),
    "apps.undo":      ("撤回投递", "撤回投遞", "Not applied", "Pas envoyée", "No enviada"),
    "apps.undo_hint": ("退回收藏夹。已写的标注会保留。", "退回收藏夾。已寫的標註會保留。",
                       "Move back to Starred. Your annotations are kept.",
                       "Remettre dans les favoris. Vos annotations sont conservées.",
                       "Devolver a Favoritos. Tus anotaciones se conservan."),
    "apps.applied_on": ("投递于 {date}", "投遞於 {date}", "Applied {date}",
                        "Envoyée le {date}", "Enviada el {date}"),
    "apps.days_since": ("已 {n} 天", "已 {n} 天", "{n} day ago|{n} days ago",
                        "il y a {n} jour|il y a {n} jours", "hace {n} día|hace {n} días"),
    "apps.today":     ("今天", "今天", "today", "aujourd'hui", "hoy"),

    # 四个阶段
    "stage.applied":  ("已投递", "已投遞", "Applied", "Envoyée", "Enviada"),
    "stage.test":     ("笔试 · code test", "筆試 · code test", "Test",
                       "Test technique", "Prueba técnica"),
    "stage.interview": ("面试", "面試", "Interview", "Entretien", "Entrevista"),
    "stage.closed":   ("结束", "結束", "Closed", "Terminée", "Cerrada"),
    ...
    "ann.url_ph":     ("https://…",) * 5,
    "ann.delete":     ("删除", "刪除", "Delete", "Supprimer", "Eliminar"),
    "ann.save":       ("添加", "新增", "Add", "Ajouter", "Añadir"),
    "ann.update":     ("保存", "儲存", "Save", "Enregistrer", "Guardar"),
    "ann.edit_hint":  ("点击编辑", "點擊編輯", "Click to edit", "Cliquer pour modifier",
                       "Clic para editar"),
    "ann.edit_event": ("编辑时间", "編輯時間", "Edit date", "Modifier la date", "Editar fecha"),
    "ann.edit_note":  ("编辑备注", "編輯備註", "Edit note", "Modifier la note", "Editar nota"),
    "ann.edit_link":  ("编辑链接", "編輯連結", "Edit link", "Modifier le lien", "Editar enlace"),
    "ann.cancel":     ("取消", "取消", "Cancel", "Annuler", "Cancelar"),
    "ann.none":       ("还没有", "還沒有", "None yet", "Aucune", "Ninguna"),
    "ann.event_done": ("已过", "已過", "done", "passé", "pasado"),
    "ann.need_name":  ("先写个事件名", "先寫個事件名", "Give it a name first",
                       "Donnez-lui un nom", "Ponle un nombre"),
    "ann.need_url":   ("先填链接地址", "先填連結地址", "Enter a URL first",
                       "Saisissez une URL", "Introduce una URL"),

    "toast.applied":  ("已移入申请追踪", "已移入申請追蹤", "Moved to Applications",
                       "Déplacée vers Candidatures", "Movida a Candidaturas"),
    "toast.unapplied": ("已退回收藏夹", "已退回收藏夾", "Moved back to Starred",
                        "Remise dans les favoris", "Devuelta a Favoritos"),

    "cal.pick_color": ("点击换颜色", "點擊換顏色", "Click to change colour",
                       "Cliquer pour changer la couleur", "Clic para cambiar el color"),
    "color.red":    ("赤", "赤", "Red", "Rouge", "Rojo"),
    "color.orange": ("橙", "橙", "Orange", "Orange", "Naranja"),
    "color.yellow": ("黄", "黃", "Yellow", "Jaune", "Amarillo"),
    "color.green":  ("绿", "綠", "Green", "Vert", "Verde"),
    "color.cyan":   ("青", "青", "Cyan", "Cyan", "Cian"),
    "color.blue":   ("蓝", "藍", "Blue", "Bleu", "Azul"),
    "color.purple": ("紫", "紫", "Purple", "Violet", "Morado"),
