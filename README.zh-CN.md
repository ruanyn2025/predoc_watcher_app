...
**日历** —— 月历视图，显示三类标记：收藏的提醒日、申请追踪里自定义的时间点、以及投递日期。可翻月。7 天内的用实心标记，更远的用浅底。光标停在标记上会浮出机构和导师，点击跳回对应的收藏夹或申请追踪页。
...
- 窗口里可以右键复制了。
- 申请追踪页的卡片补回研究领域、截止日期和标签，和收藏夹看到的一样多。

### 2026-09-20

- 日历新增「已投递」标记，显示每条申请的投递日期。

### 2026-09-12

- 申请追踪页补上「抓取于」徽章，岗位被撤下时也会标出。

### 2026-09-11

- 修复：标记为已投递后，该岗位仍留在首页「即将到期」和日历里。
